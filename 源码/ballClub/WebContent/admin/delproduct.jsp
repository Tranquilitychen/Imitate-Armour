...
<link rel="stylesheet" href="${pageContext.request.contextPath }/css/delproduct.css">
<body>
...
<div class="admin_prolist clearfix">
<c:forEach items="${adminProductlist }" var="pro">
    ...
    <div class="admin_pro clearfix">
		...
		<div class="del fr"><a href="${pageContext.request.contextPath}/adminServlet?method=delproduct&&pid=${pro.pid}">删除</a></div>
    </div>
